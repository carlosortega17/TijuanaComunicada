...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng bache = new LatLng(Double.parseDouble(getIntent().getStringExtra("LONGITUD")), Double.parseDouble(getIntent().getStringExtra("LATITUD")));
        mMap.addMarker(new MarkerOptions().position(bache).title("Bache"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(bache));
